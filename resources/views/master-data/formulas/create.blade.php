...
<div class="flex justify-between items-center mb-6">
    <div>
        ...
        <p class="text-gray-600">Create a new product formula</p>
    </div>
...
<div class="bg-white rounded-lg shadow-sm border border-gray-200">
    <form action="{{ route('formulas.store') }}" method="POST" id="formula-form" x-data="formulaForm()">
        @csrf
        <div class="p-6 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">Formula Information</h3>
            <p class="text-sm text-gray-600 mt-1">Enter the basic formula details</p>
        </div>
            ...
            <div>
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">Select materials and specify quantities for this formula</p>
                    </div>
                    <button type="button" 
                            @click="addMaterial()"
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end space-x-3">
            ...
            <button type="submit" 
                    ...
                    x-text="isSubmitting ? 'Creating...' : 'Create Formula'">
            </button>
        </div>
    </form>
</div>
...
function formulaForm() {
    return {
        ...
        init() {
            // Add one initial material row
            this.addMaterial();
            
            // Pre-populate with old values if validation failed
            @if(old('materials'))
            ...
            document.getElementById('formula-form').addEventListener('submit', (e) => {
                ...
                // Show loading state
                Swal.fire({
                    title: 'Creating Formula...',
                    text: 'Please wait while we create your formula.',
                    icon: 'info',
