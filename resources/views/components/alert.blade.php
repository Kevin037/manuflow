...
$icons = [
    ...
    'success' => 'M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.236 4.53L7.53 10.53a.75.75 0 00-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z',
...
<div {{ $attributes->merge(['class' => 'rounded-md border p-4 ' . ($classes[$type] ?? $classes['info'])]) }} 
    ...
    <div class="flex">
        <div class="flex-shrink-0">
            <svg class="h-5 w-5 {{ $iconColors[$type] ?? $iconColors['info'] }}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
        ...
        @if($dismissible)
            <div class="ml-auto pl-3">
                <button @click="show = false" class="inline-flex rounded-md bg-transparent p-1.5 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-offset-2">
