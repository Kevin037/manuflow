<x-guest-layout>
        ...
        <div class="flex items-start">
            ...
            <div class="ml-3">
                <p class="text-sm text-blue-800">
                    {{ __('For your security, please confirm your password before accessing this sensitive area of the application.') }}
                </p>
            </div>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('password.confirm') }}" class="space-y-6">
        ...
        <!-- Password -->
        <div>
            <x-input-label for="password" :value="__('Current password')" class="block text-sm font-medium text-gray-700" />
            <div class="mt-1">
        ...
        <div>
            <button type="submit" 
                ...
                <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                    <i class="fas fa-check text-primary-500 group-hover:text-primary-400 transition-colors duration-200"></i>
                </span>
                {{ __('Confirm password') }}
            </button>
        </div>
        ...
        <div class="mt-6">
            <div class="relative">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-2 bg-white text-gray-500">Need to go back?</span>
                </div>
            </div>
